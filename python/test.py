...
def refactor_code_with_ai(user_code, requirements, reasons):
    ...
    Do not explain the changes made. Just refactor the code. Do not add test cases and file name.
    Provide only the raw Java code without any markdown or formatting symbols. Do not add the pacakage name.
